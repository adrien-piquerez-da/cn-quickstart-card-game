...
APP_PROVIDER_WALLET_ADMIN_TOKEN=$(get_user_token $AUTH_APP_PROVIDER_WALLET_ADMIN_USER_NAME $AUTH_APP_PROVIDER_WALLET_ADMIN_USER_PASSWORD $AUTH_APP_PROVIDER_AUTO_CONFIG_CLIENT_ID $AUTH_APP_PROVIDER_TOKEN_URL)
